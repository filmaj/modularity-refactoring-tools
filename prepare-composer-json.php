...
$pathTypeConfig = [
    ...
    'repositories' => [
        [
            "type" => "path",
            "url" => "./magento2ce/app/code/Magento/*/*"
        ],
        [
            "type" => "path",
            "url" => "./magento2ce/app/code/Magento/*"
        ...
        [
            "type" => "path",
            "url" => "./magento2ce/lib/internal/Magento/Framework/*/*"
        ],
        [
            "type" => "path",
            "url" => "./magento2ce/lib/internal/Magento/Framework/*"
        ...
        [
            "type" => "path",
            "url" => "./magento2ce/lib/internal/Magento/*"
        ]
    ]
];
...
$rootComposerJsonData['require'] = array_merge($rootComposerJsonData['require'], $addToRequire, $additionalPackages);
